...
<div class="container" style="width: 30%; margin:auto;">
     <form method="POST" action="/success/price" class="pt-5">
          @csrf
          <h1 class="mb-3">Добавить цену</h1>
          <div class="mb-3">
            <label  for="" class="form-label text-light">Цена</label>
            <input type="" name="money" class="form-control" id="">
          </div>
          <div class="mb-3">
            <div class="mb-3">
                <select name="time" class="form-select" aria-label="Default select example">
                    <option selected>Выберете часы</option>
