...
<div class="container" style="width: 30%; margin:auto;">
     <form method="POST" action="/" class="pt-5">
          @csrf
          <h1 class="mb-3">Забронировать место</h1>
          <div class="mb-3">
...
<div class="main">
  <hr class="mb-5">
<div class="container pt-5" style="width: 30%; margin:auto; height: 68%">
     <form class="">
          <h1 class="pb-3 "> Чтобы забронировать место </h1>
          <h2 class=""><a style="text-black" href="{{route("register.create")}}">зарегистрируйтесь</a> или <a style="text-black" href="{{route("register.login")}}">войдите</a></h2>
</div>
